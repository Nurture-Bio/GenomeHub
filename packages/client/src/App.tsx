        ...
        <NavLink
          ...
          className={({ isActive }) =>
            cx(
              ...
              'gap-2.5 w-full text-left cursor-pointer bg-transparent no-underline',
            )
          }
        >
          {icons[item.icon]}
  ...
  return (
    <div className="px-4 py-3 border-t border-white/10 flex items-center gap-2.5">
      ...
      <button
        onClick={logout}
        className={cx(
          iconAction({ color: 'dim' }),
          'shrink-0 p-1 min-h-5.5 min-w-5.5 flex items-center justify-center',
        )}
        title="Sign out"
      >
        <svg
    ...
    <div className="flex flex-col md:flex-row h-full" style={{ background: 'var(--color-surface-sunken)' }}>
      ...
      >
        ...
        <button
          ...
          className={cx(
            iconAction({ color: 'dim' }),
            'flex items-center justify-center min-h-5.5 min-w-5.5',
          )}
      ...
      <Dialog.Root open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
        <Dialog.Portal>
          ...
          <Dialog.Content
            className="fixed inset-y-0 left-0 z-modal flex flex-col animate-slide-in-left sidebar-surface"
            style={{ width: 260 }}
