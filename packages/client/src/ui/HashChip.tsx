      ...
      className={cx(
        ...
        onClick &&
          [
            ...
            'hover:[--hc-border:var(--color-interactive)] hover:[--hc-fg:var(--color-interactive)]',
            'hover:shadow-[0_0_2px_var(--color-interactive),inset_0_0_2px_var(--color-interactive)]',
            'active:shadow-[0_0_1px_var(--color-interactive),inset_0_0_1px_var(--color-interactive)]',
          ].join(' '),
        onRemove && 'group/chip',
        className,
      )}
