...
import { useStrandFile, type RangePlan, type SecondaryFilters } from '../hooks/useStrandFile';
...
const VirtualRows = memo(function VirtualRows({
  ...
  return (
    <>
      ...
      <div
        style={{ position: 'relative', width: TOTAL_WIDTH, marginTop: -virtualizer.getTotalSize() }}
      >
...
export default function DevRangePage() {
  ...
  const getRow = useCallback(
    (index: number): Record<string, unknown> | null | undefined => {
    ...
    return (
      ...
      >
        ...
        <Text
          variant="dim"
          as="p"
          style={{ maxWidth: 480, textAlign: 'center', marginTop: '0.5rem' }}
        >
          Run the generator first:
        </Text>
        <code
    ...
    >
      ...
      >
        ...
        {isLoading ? (
          ...
          <Text variant="dim">
            {meta.recordCount.toLocaleString()} records · 30.5 MB binary file
          </Text>
        ) : null}
        ...
        {meta && startStats && (
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <FacetSelect
              ...
              values={chromValues}
              active={chromFilter}
              onSelect={handleChromChange}
            />
            <FacetSelect
              label="strand"
              values={strandValues}
              active={strandFilter}
              onSelect={handleStrandChange}
            />
          </div>
        )}
