...
import { User, Project, Organism, ExperimentType, Experiment, Dataset, EntityEdge, GenomicFile } from './entities/index.js';
...
export const AppDataSource = new DataSource({
  ...
  entities: [User, Project, Organism, ExperimentType, Experiment, Dataset, EntityEdge, GenomicFile],
